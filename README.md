...
## Purpose
Build a local, source-linked dataset for Hong Kong post-secondary admissions reference. The project focuses on actual admission score data first, then programme requirements, programme descriptions, and official programme links.
...
1. Build a static searchable score table first.
2. Add source-linked programme detail pages.
3. Add AI answer/RAG only after the structured dataset is reliable.
